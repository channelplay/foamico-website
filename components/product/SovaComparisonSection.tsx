...
export default function SovaComparisonSection() {
  const comparisonData = [
    ...
    },
    {
      ...
      premium: { text: 'Memorest Foam Quilt', color: 'text-amber-600' },
      luxury: { text: 'Memorest Foam Quilt', color: 'text-amber-600' }
    },
    {
      feature: 'Body Support Layer',
      classic: { text: 'Pulse Core Foam', color: 'text-gray-700' },
      premium: { text: 'Pulse Core Foam', color: 'text-gray-700' },
      luxury: { text: 'Pulse Core Foam', color: 'text-gray-700' }
    },
    {
      feature: 'Main Support',
      classic: { text: 'Bondtech Support Foam', color: 'text-gray-700' },
      premium: { text: 'Bondtech Support Foam', color: 'text-gray-700' },
      luxury: { text: 'Zero G Latex Foam', color: 'text-purple-600' }
    },
    {
      feature: 'Bottom Layer',
      classic: { text: 'Support Foam Quilt', color: 'text-gray-700' },
      premium: { text: 'Support Foam Quilt', color: 'text-gray-700' },
      luxury: { text: 'Soft Foam with Quilt', color: 'text-gray-700' }
    },
    {
      feature: 'Feel',
      classic: { text: 'Medium-Firm', color: 'text-blue-600' },
      premium: { text: 'Medium', color: 'text-orange-600' },
      luxury: { text: 'Medium-Soft', color: 'text-purple-600' }
    },
    {
      feature: 'Best For',
      classic: { text: 'Basic orthopedic comfort', color: 'text-gray-600' },
      premium: { text: 'Memory foam comfort with support', color: 'text-gray-600' },
      luxury: { text: 'Premium feel with latex durability', color: 'text-gray-600' }
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Compare Sova Variants
          </h2>
          <p className="text-xl text-gray-600">
            Find the perfect match for your comfort needs
          </p>
        </div>
