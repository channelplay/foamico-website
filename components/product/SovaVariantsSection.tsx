        ...
        <div className="space-y-24">
          {variants.map((item, index) => (
            ...
            >
              ...
              {/* Content Side */}
              <div className={`h-[500px] flex flex-col ${item.imagePosition === 'right' ? 'lg:col-start-1' : ''}`}>
                  ...
                  {item.variant.layers?.map((layer, layerIndex) => (
                    <div key={layerIndex}>
                      <motion.button
                        ...
                        className="w-full px-6 py-4 flex items-center justify-between bg-soft-cream hover:bg-warm-beige/50 transition-colors rounded"
