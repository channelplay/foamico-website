...
const variants = [
  { id: 'classic', name: 'Sova Classic', selected: true },
  { id: 'premium', name: 'Sova Premium', selected: false },
  { id: 'luxury', name: 'Sova Luxury', selected: false }
]

const features = [
  { icon: '◈', text: 'Smart Layers', color: 'hud-cyan' },
  { icon: '◉', text: 'Relieves Backpain', color: 'hud-green' },
  ...
  return (
    <section className="min-h-screen bg-cyber-black relative overflow-hidden py-12">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-b from-hud-cyan/5 via-transparent to-hud-green/5"
          animate={{
      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative hologram-card h-[600px]">
              ...
              {/* Scan Effect */}
              <motion.div
                className="absolute inset-x-0 h-1 bg-gradient-to-r from-transparent via-hud-cyan to-transparent z-10"
                animate={{
                  top: ['-4px', '100%'],
                }}
                transition={{
          ...
          >
            ...
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-cyber font-bold mb-6">
                <span className="neon-text-green">SOVA</span>
              </h1>
              <p className="text-lg font-mono text-hud-cyan/70 leading-relaxed">
                Experience the perfect balance of firmness and comfort with 
                <span className="text-hud-green"> BONDTECH SUPPORT FOAM </span>
                for enhanced orthopedic support.
              </p>
            </div>
        ...
        <motion.div 
          ...
          transition={{ duration: 2, repeat: Infinity }}
        >
          <div className="glass-panel px-4 py-2 border border-hud-cyan">
            <div className="flex items-center gap-2">
              <span className="text-xs font-mono text-hud-cyan">SCROLL</span>
              <motion.div
                animate={{ y: [0, 5, 0] }}
