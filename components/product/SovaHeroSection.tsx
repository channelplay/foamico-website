      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h1 className="text-5xl font-bold text-gray-900 mb-6">Sova</h1>
              <p className="text-lg text-gray-600 leading-relaxed">
                Experience the perfect balance of firmness and comfort with Sova mattresses, featuring Bondtech Support Foam for enhanced orthopedic support.
              </p>
            </div>
